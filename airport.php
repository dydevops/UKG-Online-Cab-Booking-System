...
<html>
  <head>
	...
	<title>Airport Transfer And Point To Point Fare</title>
  ...
  <body>
	...
	<main class="main" role="main" style="background-color: #2b2a29;">
		...
		<header class="site-title color">
			<div class="wrap">
				<div class="container">
					<h1 class="text-center">Airport Transfer Cab Booking</h1>
				</div>
			</div>
		</header>
		<!-- //Page info -->
		<div class="wrap">
			<div class="row">
				...
				<div class="three-fourth">
					...
					<form method="post" action="airport-booking-confirm.php">
						...
						<div class="f-row">
							<div class="one-half">
								...
								<input type="text" name="mobile_number" id="number" required />
							</div>
						</div>
