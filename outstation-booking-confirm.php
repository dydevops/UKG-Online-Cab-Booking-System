...
$rs = "insert into booking(package,fullname,email,mobile_number,pick_city,pick_address,drop_city,drop_address,cab_type,cab_rate,distance,details,calender_day,micro_fare,da,pick_date,pick_time,return_date,return_time,sp_remark,payment_method,time_now) 
       values('Outstation','$fullname','$email','$mobile_number','$pick_city','$pick_address','$drop_city','$drop_address','$cab_type','$cab_rate','$distance','$details','$calender_day','$micro_fare','$da','$pick_date','$pick_time','$return_date','$return_time','$sp_remarks','CASH',now())";
$res = $mysqli->query($rs);
...
$cust_details = '<table style="font-family:Verdana, Geneva, sans-serif; font-size: 12px; background:#999999; width:700px; border:none;" cellpadding="5" cellspacing="1">
		...
		<tr>
           ...
           <td bgcolor="#ffffff" align="left" colspan="6">One Day Outstation</td>
        </tr>
		<tr>
	...
	$mail_body .= "Please book the following Outstation for the customer<br><br>";
  ...
  <body>
	...
	<main class="main" role="main" style="background-color: #2b2a29;">
		...
		<header class="site-title color">
			<div class="wrap">
				<div class="container">
					<h1>Thank you. Your Outstation booking is now confirmed.</h1>
				</div>
			</div>
		</header>
		<!-- //Page info -->
