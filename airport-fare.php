...
<html>
  <head>
	...
	<title>Book Airport Transfer And Point To Point Fare Cabs at Best Fares | Hire Airport Transfer And Point To Point Fare Cabs Online | Airport Transfer And Point To Point Fare Cabs Service at ukgcab.com</title>
		...
		<div class="wrap">
			<div class="row">
				...
				<form action="booking-details.php" method="post" >
					<div class="results">
						<?php 
						  $rs = $mysqli->query("select * from airportfare");
						...
						<article class="result">
							...
							<div class="one-fourth heightfix">
								<div>
									...
									<a href="airport.php?cab_type=<?php echo $cabtype; ?>" class="btn grey large">select</a>
								</div>
							</div>
